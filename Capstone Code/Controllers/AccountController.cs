...
namespace TestWebApplication.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            //this.Session["userPicture"] = info.ExternalPrincipal.FindFirstValue("pictureUrl");
            ...
            {
                var json = webClient.DownloadString(apiRequestUri);
                dynamic resulta = JsonConvert.DeserializeObject(json);
                userPicture = resulta.picture;
                this.Session["userPicture"] = resulta.picture;
            }
            ...
            switch (result)
            {
                ...
                default:
                    ...
                    //this.Session["userPicture"] = loginInfo.ExternalIdentity.FindFirstValue("pictureUrl");
